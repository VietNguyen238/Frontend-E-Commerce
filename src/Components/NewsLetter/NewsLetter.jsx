...
export default function NewsLetter() {
    return (
        <div className="w-[65%] h-[50vh] flex flex-col justify-center items-center m-auto px-0 py-[140px] mb-[150px] bg-gradient-to-b from-violet-gradient to-white gap-[30px]">
